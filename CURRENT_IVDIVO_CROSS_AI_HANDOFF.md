# CURRENT — IVDIVO CROSS-AI HANDOFF / RESUME CARD
...
Do NOT repeat E07–E12 reconciliation, season-wide final gate, or generate E25. Do not silently Founder-lock the season. Real performance/blind-listener evidence and any narrow release-stage legal/finance specialist review remain downstream external gates, not AI-simulated PASS.

Current clean repaired branch includes E12 v1.1 `1KYGkD--RIAWPOVhSrb6YUiLHyg3keDpdUaYKqgrZiw4`, E13 v1.1 `1X8Y6ICUeVql9QQ_ZYe-SpSZUsAf3TMQYh43llLWO4Y0`, E14 v1.1 `1NVnSy-UcdjBO2iWjNqts3VlEwPW0fdWb9FjPT7jVUBs`, E15 v1.1 `1QgOlbUOUF1MTkKblq0l6LTb7Yk-36uqOfCIiALTK47s`.
...
Do not restart or casually rewrite:
- LESSON ZERO — development locked.
- ORBITAL YOUTH — text complete/locked ending.
- ROOM 917 — season text complete.
- BODYGUARD FOR THE FALLEN IDOL — text complete.
- SEVEN NIGHTS BEFORE CODE BLUE — text complete.
- NINETY MISSING MINUTES — text complete / story locked / publication specialist hold.
- SHE STOLE MY NAME — E01–E24 story locked.
- THE PERFECT WIFE KNOWS — E01–E24 story locked.
- SHE FIRED THE BILLIONAIRE — E01–E24 story locked.
- THE MAN WHO CAME BACK — E01–E24 text complete / Final Story Gate PASS / awaiting Founder lock decision only.

## Cross-model execution contract

Universal prompt authority: `IVDIVO_NARRATIVE_OS/14_MULTI_MODEL_HANDOFF_PROMPTS.md`.
Human/Drive execution card: `MULTI_MODEL_AGENT_RUN_CARD_TEMPLATE v1.1`, Drive ID `13qXjDsHD903j6RcdnOoy4-qmKggWzYOiMDuV_N0Ri_U`.

Every Claude/Grok/GPT/other-model job receives one bounded RUN CARD:
- PROJECT / LINE;
- ACTIVE AUTHORITY;
...
These are abstract mechanisms from REFERENCE ONLY craft sources and must not reopen GREEN/locked story text without actual evidence.
...
Current Story Recovery v0.5 remains a WORKING upgrade candidate. Its transactional repair mechanisms may be inherited selectively, but it does not supersede IDEA→STORY v1.0.0 / current Story Engine authority until explicit promotion gates close.

P53 neighboring runtime files are useful **domain overlays**, not a second universal Narrative OS: the P53 Dialogue Runtime Autorun is accepted for romance/dialogue work; P53 Global Autorun, experiment ledger and multi-AI protocol inherit higher Narrative OS authority rather than replacing it.

PR #45 `continuous-studio-merge` is CLOSED / NOT MERGED / SUPERSEDED BY NEWER MAIN. Do not resurrect it as the current integration target.
