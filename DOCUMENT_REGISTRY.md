...
Дата обновления: 2026-07-22 (добавлен CARD-002 PORTAL_RISK_DECK_v0.1_DRAFT; ранее: архивация разговора 2026-07-12, NARR-003, MECH-001 P49.4, 13_AI_RESULTS/CROSS_MODEL_AUDIT_PROTOCOL, OPEN_QUESTIONS.md, COMP-003, COMP-004, MECH-001 P49.3, TEST-001 §7, templates, архив 6 документов)
...
| CARD-001 | PROTOTYPE_V01_COMPONENTS_v0.1_DRAFT | docs/04_CARDS_AND_COMPONENTS/ | DRAFT (все числа HYPOTHESIS) | v0.1 | карты/компоненты, механика | GCORE-001, MECH-001, MATH-001 | ENT-001, TEST-001 |
| CARD-002 | PORTAL_RISK_DECK_v0.1_DRAFT | docs/04_CARDS_AND_COMPONENTS/ | DRAFT (36 карт риска перехода; все цены/эффекты HYPOTHESIS) | v0.1 | карты/компоненты, механика | CARD-001, GCORE-001, MECH-001 | WORLD-002, TEST-001, TERM-001 |
...
## Пробелы по категориям (на 2026-07-22)
...
| механика | 3 документа + CARD-002 как тестовый карточный компонент | Хорошее покрытие, но не APPROVED |
| мир | 1 документ в GitHub, актуальная Drive-архитектура WORLD-002 требует синхронизации | Требуется sync Drive → GitHub |
...
| карты/компоненты | 2 документа | CARD-001, CARD-002 |
...
Обновление 2026-07-22: добавлен CARD-002 `PORTAL_RISK_DECK_v0.1_DRAFT` — 36 карт риска перехода как тестовая колода космологической нестабильности.
