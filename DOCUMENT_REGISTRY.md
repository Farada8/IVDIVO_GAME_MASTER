...
Дата обновления: 2026-07-11 (добавлены MECH-003 и TEST-002; CORE-001 обновлён до v1.3)
...
- **SUPERSEDED** — конкретное положение заменено более поздним решением; остальной документ может оставаться рабочим
...
|---|---|---|---|---|---|---|---|
| CORE-001 | PROJECT_CORE_CONTEXT | /PROJECT_CORE_CONTEXT.md | ACTIVE (не Draft/Review/Approved — корневой документ, статус вне обычной шкалы) | v1.3 | бизнес, мир, канон (родитель для всех) | — | все документы ниже |
| GCORE-001 | GAME_CORE_v0.1_DRAFT | docs/03_MECHANICS/ | MIGRATION-PARTIAL / DRAFT | v0.1 | механика | CORE-001 | MECH-001, MECH-002, MECH-003, MATH-001, WORLD-001, ENT-001 |
| MECH-001 | GAME_MECHANICS_v0.1_DRAFT | docs/03_MECHANICS/ | DRAFT; P49.1 SUPERSEDED решением DEC-013 | v0.1 | механика | GCORE-001 | MECH-002, MECH-003, MATH-001, WORLD-001, TEST-002 |
| MECH-002 | WORLD_ECONOMY_SYSTEM_v0.1_APPROVED | docs/03_MECHANICS/ | APPROVED / FOUNDER-DECISION | v0.1 | механика, мир, бизнес | CORE-001, GCORE-001 | MECH-001, MECH-003, MATH-001, WORLD-001, ENT-001, NARR-002 |
| MECH-003 | PORTAL_CONJUNCTION_SYSTEM_v0.1_APPROVED | docs/03_MECHANICS/ | APPROVED / FOUNDER-DECISION | v0.1 | механика, мир | CORE-001, GCORE-001, MECH-001 | MECH-002, MATH-001, CARD-001, TEST-002, WORLD-001, ENT-001 |
| MATH-001 | GAME_MATH_v0.1_DRAFT | docs/03_MECHANICS/ | DRAFT (числа = HYPOTHESIS) | v0.1 | механика | MECH-001 | GCORE-001, MECH-002, MECH-003, WORLD-001, ENT-001, TEST-002 |
| WORLD-001 | WORLD_ARCHITECTURE_v0.1_DRAFT | docs/05_WORLDS/ | DRAFT | v0.1 | мир | CORE-001 | GCORE-001, MECH-001, MECH-002, MECH-003, ENT-001, NARR-002 |
| ENT-001 | ENTITIES_AND_CHARACTERS_v0.1_DRAFT | docs/06_CHARACTERS_AND_ARCHETYPES/ | DRAFT (P25 частично зависит от канона — не Draft, а BLOCKED) | v0.1 | персонажи | GCORE-001, WORLD-001 | NARR-002, MATH-001, MECH-002, MECH-003, COMP-001 (коллизия имени "Кут Хуми") |
...
| NARR-002 | NARRATIVE_SYSTEM_v0.1_DRAFT | docs/07_CAMPAIGNS_AND_STORIES/ | DRAFT (P53 — BLOCKED, зависит от канона) | v0.1 | персонажи, мир | STORY-001, WORLD-001, ENT-001 | MECH-002, MECH-003 |
...
| CARD-001 | PROTOTYPE_V01_COMPONENTS_v0.1_DRAFT | docs/04_CARDS_AND_COMPONENTS/ | DRAFT (все числа HYPOTHESIS) | v0.1 | механика | GCORE-001, MECH-001, MATH-001 | ENT-001, TEST-001, TEST-002, MECH-003 |
| TEST-001 | PLAYTEST_PROTOCOL_v0.1_DRAFT | docs/14_TESTING_AND_BALANCE/ | DRAFT | v0.1 | механика | MATH-001 | CARD-001, KS-001, TEST-002 |
| TEST-002 | PORTAL_GATE_PLAYTEST_v0.1_DRAFT | docs/14_TESTING_AND_BALANCE/ | DRAFT / REQUIRED TEST | v0.1 | механика | MECH-003, TEST-001 | MECH-001, MATH-001, CARD-001 |
...
| механика | 5 основных документов + 2 тестовых | GCORE-001, MECH-001, MECH-002, MECH-003, MATH-001; TEST-001 и TEST-002 проверяют систему; P49.1 старой модели отменён |
| мир | 3 документа | WORLD-001 и междисциплинарные MECH-002/MECH-003; архитектура миров требует разрешения коллизии ранней и поздней моделей |
| персонажи | 2 документа | ENT-001, STORY-001/NARR-002 частично; роли портала уточнены в MECH-003 |
...
Обновление 2026-07-11: пробелы «Kickstarter» и «цифровая версия» закрыты отдельными документами (KS-001, DIG-001); добавлено покрытие разделов 01, 02, 04, 14 (RES-001, CONC-001, CARD-001, TEST-001); экономика миров зафиксирована в MECH-002; бинарный зал ожидания отменён DEC-013, новая система перехода зафиксирована MECH-003 и TEST-002.
...
5. Присвоить код (следующий свободный номер в своей категории, например MECH-004, WORLD-002).
