...
- `98_CONVERSATION_ARCHIVE/2026-07-20_AI_WORKFLOW_AND_ARCHIVE_PLAN.md` — архив текущего разговора о распределении работы GPT, Claude, Gemini и корректировке ошибочной гипотезы «Архетипы/Таро как оптимальное ядро».
- `docs/13_AI_RESULTS/AI_WORKFLOW_EXECUTION_PLAN_v0.1_DRAFT.md` (AI-001) — рабочий маршрутизационный слой для GPT / Claude / Gemini / NotebookLM; не заменяет `IVDIVO_PROMPT_LIBRARY_64_v0.1` и `IVDIVO_AI_SKILLS_LIBRARY_v0.1`.
- `OPEN_QUESTIONS.md` — создан активный реестр открытых вопросов; добавлены вопросы по AI workflow и допустимости Шмакова/Таро как внутреннего слоя War of Archetypes.

### Changed

- `DOCUMENT_REGISTRY.md` — добавлена запись AI-001 и указана связь с архивом разговора.

### Governance

- Новых APPROVED-решений не добавлено: разговор содержит рабочую гипотезу и архивную фиксацию, но не прямое утверждение основателем нового workflow как канона.
- Гипотеза «коллекционно-приключенческая игра об Архетипах, основанная на системе Таро Шмакова» зафиксирована как REJECTED/неактуальная для ядра, поскольку противоречит DEC-001—DEC-004.
