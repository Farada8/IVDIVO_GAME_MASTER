...
### Added
- `docs/04_CARDS_AND_COMPONENTS/OBJECTIVE_CARDS_v0.1_DRAFT.md` — рабочий модуль карт целей: 24 общие цели и 30 личных целей для кооперативного ядра.
- Google Drive companion sheet: `IVDIVO_OBJECTIVE_CARDS_v0.1_DRAFT` — полная таблица с колонками ID, колода, название, кому относится, условие выполнения, награда, риск, помощь общей миссии, невыполнение, тестовая заметка.

### Governance
- Статус: DRAFT / TO-VERIFY. Новых APPROVED-решений не создавалось.
- Личные цели спроектированы как кооперативные личные задачи, не как скрытое предательство.
- Баланс, частота целей, числовые награды и штрафы требуют сухого прогона и плейтеста.
