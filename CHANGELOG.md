...
- `MASTER_INDEX.md` — верхний индекс навигации по репозиторию.
- `OPEN_QUESTIONS.md` — реестр нерешённых вопросов, включая развилки по GAME CORE и DEC-012.
- `98_CONVERSATION_ARCHIVE/2026-07-20_ядро-игровой-механики.md` — архив текущего разговора о ядре игровой механики.

### Changed

- `docs/03_MECHANICS/GAME_CORE_v0.1_DRAFT.md` — расширен из частичной миграции в полную GitHub-синхронизацию текущей рабочей версии: Корневая угроза, порталы, цикл партии/раунда, ресурсы, действия, прототип, тестовые гипотезы и открытые вопросы.
- `DOCUMENT_REGISTRY.md` — v1.2: добавлен архив разговора, обновлена запись GCORE-001, зафиксирована синхронизация 2026-07-20.
- `README.md` — добавлены ссылки на `MASTER_INDEX.md`, `DOCUMENT_REGISTRY.md`, `OPEN_QUESTIONS.md` и `98_CONVERSATION_ARCHIVE/`.
- `ROADMAP.md` — следующий конкретный шаг заменён на создание `PROTOTYPE_SCENARIO_01_v0.1_DRAFT` и первый бумажный тест.

### Not changed

- `DECISIONS.md` не изменялся: в разговоре не было нового прямого APPROVED-решения основателя по GAME CORE.
