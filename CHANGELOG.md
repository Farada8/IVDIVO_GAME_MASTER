...
- `docs/08_VISUAL_BRAND/VISUAL_BRAND_CODE_v0.1_DRAFT.md` — Markdown-синхронизация Drive-документа визуального кода бренда: horror-вход, разлом-порог, рабочая визуальная формула, матрица восьми миров, ограничения и открытые вопросы.
- `98_CONVERSATION_ARCHIVE/2026-07-20_ВИЗУАЛЬНЫЙ-КОД-БРЕНДА.md` — архив текущего разговора с разделением CANON / WORKING / IDEAS / REJECTED / OPEN QUESTIONS.
- `OPEN_QUESTIONS.md` — создан общий файл открытых вопросов, начатый с блока по визуальному коду бренда.

### Changed

- `docs/README.md` — добавлены ссылки на визуальный бренд-документ и архив разговора.

### Not changed

- `DECISIONS.md` не обновлялся: в разговоре не было нового явного APPROVED-решения основателя.
- `PROJECT_CORE_CONTEXT.md` не обновлялся: созданный визуальный код имеет статус DRAFT и не меняет фундамент проекта.
