...
### Added
- `docs/14_TESTING_AND_BALANCE/PLAYTEST_PROTOCOL_v0.2_DRAFT.md` — расширенный протокол тестирования: форма одной партии, диагностика объяснения правил, длительности, понятности хода, решений, порталов, Разлома, Искажения, Корня, финального выбора, downtime и желания повторной игры; добавлены метрики успеха, зоны наблюдения, пороги обязательной переделки и гейты перехода между волнами.

### Changed
- `PLAYTEST_PROTOCOL_v0.1_DRAFT.md` сохранён как предыдущая версия; v0.2 становится текущей рабочей версией TEST-001 после review.
