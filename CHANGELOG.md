...
- `98_CONVERSATION_ARCHIVE/2026-07-20_ЦИФРОВАЯ-МОДЕЛЬ-И-ПРОТОКОЛ.md` — архив разговора о цифровой модели, коммерческой франшизе и протоколе архивации.
- `MASTER_INDEX.md` — навигационный индекс GitHub-версии проекта.
- `OPEN_QUESTIONS.md` — активный список нерешённых вопросов, выделенных из архива разговора.

### Changed

- `docs/11_DIGITAL_PRODUCT/DIGITAL_COMPANION_v0.1_DRAFT.md` — добавлен раздел 7: расширенная цифровая экосистема как WORKING / NOT MVP.
- `docs/12_FRANCHISE/COMMERCIAL_FRANCHISE_MODEL_v0.1_DRAFT.md` — добавлен раздел 10: связь франшизной платформы с цифровой моделью.
- `DOCUMENT_REGISTRY.md` — добавлены записи для архива разговора, MASTER_INDEX и OPEN_QUESTIONS.

### Open

- Требуется решение основателя: какой цифровой уровень является ближайшим после бумажного прототипа.
- Зафиксирован конфликт уровня детализации: расширенная цифровая экосистема шире текущего DIG-001 и не должна заменять принцип необязательности приложения.
