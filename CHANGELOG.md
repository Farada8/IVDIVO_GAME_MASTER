...
- `98_CONVERSATION_ARCHIVE/2026-07-20_архетипическая-эмоциональность.md` — архив разговора с разделением CANON / WORKING / IDEAS / REJECTED / OPEN QUESTIONS.
- `docs/15_EDUCATION_AND_PSYCHOLOGY/ARCHETYPICAL_EMOTIONALITY_v0.1_DRAFT.md` — рабочая спецификация архетипической эмоциональности как игрового слоя: эмоции как ресурс/цена/состояние/триггер/трансформация, четыре слоя персонажа, пример карты «Испытание Тьмы», матрица архетипов.
- `MASTER_INDEX.md` — краткий верхнеуровневый навигационный индекс, не заменяющий `DOCUMENT_REGISTRY.md`.
- `OPEN_QUESTIONS.md` — единый список открытых вопросов; добавлен блок по архетипической эмоциональности и предупреждение по DEC-015.

### Changed

- `DOCUMENT_REGISTRY.md` → v1.2: добавлены `MASTER-001`, `OPENQ-001`, `ARCHETYPE-EMO-001`, `ARCH-2026-07-20-ARCHETYPE-EMO`; добавлено предупреждение, что WORLD-001 частично устарел относительно текущего Drive-контекста v1.6 / DEC-015.

### Governance

- Новых APPROVED-решений в разговоре не было. `DECISIONS.md` не изменялся.
- Детальная модель архетипической эмоциональности сохранена как DRAFT / WORKING, а не как канон.
- Найден конфликт: старые документы ещё ссылаются на восьмимировую вертикаль, тогда как актуальный Drive-контекст v1.6 фиксирует DEC-015: пять вертикальных миров + орбитали. В новых документах это явно отмечено.
