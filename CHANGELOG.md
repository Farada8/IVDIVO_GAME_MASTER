...
- `docs/07_CAMPAIGNS_AND_STORIES/CORE_BOX_CAMPAIGN_v0.1_DRAFT.md` — кампания IVDIVO Core Box: банк 16 сценариев, рекомендуемый путь 12 сценариев, 40 карт кампании, non-legacy модель, прогрессия введения систем и открытые вопросы плейтеста.

### Changed

- `docs/README.md` — добавлена ссылка на Core Box Campaign.
- `OPEN_QUESTIONS.md` — добавлены открытые вопросы по кампании Core Box.

### Not changed

- `DECISIONS.md` не обновлялся: документ имеет статус DRAFT и не содержит нового APPROVED-решения основателя.
- `PROJECT_CORE_CONTEXT.md` не обновлялся: GitHub-копия остаётся технически устаревшей относительно Drive v1.6; кампания создана по актуальному Drive-контексту, WORLD-002 / DEC-015 и WORLD-004.
