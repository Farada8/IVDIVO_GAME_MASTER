...
- `IVDIVO_WRITING_PRODUCTION_CANON.md` — канон написания книг, рассказов, сериалов, сцен и диалогов ИВДИВО v1.0. Зафиксированы Story-before-text, законченная локальная история эпизода, двойной контур сериализации, обязательные Story Core и Story Gate, character-first, правила сцен и диалогов, отказ от обязательного эзотерического словаря, observable ontology, технический паспорт сверхспособностей, цена/ограничения/противодействие, визуально-звуковой язык сверхфизики, voice-production passport и политика изучения загруженных произведений без копирования.

### Changed

- `README.md` — канон художественного производства добавлен в список главных файлов и как обязательная точка входа перед написанием новой книги, серии или крупного сценарного блока.

### Canon protocol

- Новое прямое уточнение Yaromyr Farada имеет приоритет над старой редакцией писательского канона.
- При устойчивом изменении производственного принципа обновляется версия `IVDIVO_WRITING_PRODUCTION_CANON.md`, а изменение фиксируется в его внутреннем CHANGELOG и в этом журнале.
- Отвергнутые правила не возвращаются автоматически из старых разговоров или архивных документов.
