...
- `98_CONVERSATION_ARCHIVE/2026-07-20_образовательные-сценарии.md` — архив текущего разговора о образовательных сценариях, с разделением CANON / WORKING / IDEAS / REJECTED / OPEN QUESTIONS.
- `docs/15_EDUCATION_AND_PSYCHOLOGY/EDUCATIONAL_SCENARIOS_v0.1_DRAFT.md` (EDU-001) — рабочая рамка образовательных сценариев: цикл, архитектура сценария, типы, уровни сложности, пример «Угасающий город», связь с восемью мирами и франшизой.
- `OPEN_QUESTIONS.md` — активный файл открытых вопросов, начат с вопросов по образовательной линии.
- `MASTER_INDEX.md` — главный навигационный индекс репозитория.

### Changed

- `README.md` — добавлены ссылки на `MASTER_INDEX.md`, `DOCUMENT_REGISTRY.md`, `OPEN_QUESTIONS.md` и `98_CONVERSATION_ARCHIVE/`.
- `DOCUMENT_REGISTRY.md` — добавлена строка EDU-001 и обновлена дата актуализации.

### Decision notes

- `DECISIONS.md` не обновлялся: в разговоре не было нового прямого утверждения основателя по образовательным сценариям. Материал сохранён как DRAFT / WORKING, не как APPROVED.

### Open

- Проверить образовательные сценарии после утверждения core loop.
- Разделить массовый игровой режим, добровольную рефлексию, образовательную методику и профессиональный/психологический формат.
- Согласовать образовательные сценарии с восьмью мирами DEC-003 и предложенной, но не утверждённой структурой DEC-012.
