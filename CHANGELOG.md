...
- `98_CONVERSATION_ARCHIVE/2026-07-20_ПОСРЕДНИКИ-МЕЖДУ-МИРАМИ.md` — структурированный архив разговора с разделением CANON / WORKING / IDEAS / OPEN QUESTIONS.
- `docs/IDEAS/intermediaries_between_worlds.md` — рабочая авторская концепция трансмировой группы Посредников, препятствующих пробуждению и извлекающих ресурс из снов и нереализованных возможностей души.

### Status

- Новых решений APPROVED не добавлено.
- Концепция Посредников сохранена как WORKING / IDEA и не внесена в `DECISIONS.md`.
- Зафиксирована необходимость сопоставления с идеей «Охота корпораций за спящими посвящёнными», DEC-003, DEC-011 и DEC-012.
