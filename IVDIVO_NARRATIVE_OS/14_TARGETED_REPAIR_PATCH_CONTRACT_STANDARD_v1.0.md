...
**Status:** PROPOSED CURRENT UPGRADE
**Version:** 1.0
**Date:** 2026-08-21

## PURPOSE

Promote the strongest reusable repair behavior proven in the IDEA→STORY recovery work into a universal Narrative OS rule **without** promoting the recovery package itself to authority.
