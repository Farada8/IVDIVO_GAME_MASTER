...
## Fresh-main integration note
This replay is based on current main `be23512b715f587d8d3511f9640722491e1b5214`, which already merged Cycle10/Cycle10R candidate packages. Therefore this calibration layer is additive evidence only; it does not reopen or replace those packages.

## No-promotion decision
Cycle10 calibration is an evidence-calibration adapter, not a new Self-Improvement engine and not a new SI candidate ID by itself.