...
- **N27 CONCURRENT_BRANCH_SALVAGE** — `PASS_REAL_CONCURRENCY_REBASE` — initial branch became stale because main changed SI-0015; rebase1 was created from fresh main and richer source-provenance fields were preserved.
