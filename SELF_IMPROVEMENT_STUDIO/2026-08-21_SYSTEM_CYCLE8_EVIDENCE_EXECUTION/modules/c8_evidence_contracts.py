"""System Cycle 8 bounded evidence-contract harness.

Review/canary module only. It does not replace SI-0012, SI-0014, SI-0015,
the current registry transaction authority, the writing-production Cycle8,
or any story/project authority.
"""
