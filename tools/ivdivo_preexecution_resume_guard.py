...
Candidate mechanism derived from Cycle32D. Project-specific persisted state
outranks stale aggregate router pointers. This tool does not mutate canon.
"""
...
def guard_resume(aggregate: Dict[str, Any], project: Dict[str, Any] | None) -> Dict[str, Any]:
    ...
    if aggregate_next and aggregate_next != project_next:
        return {
            ...
            "reason": "aggregate router conflicts with fresher project-specific frontier",
        }
