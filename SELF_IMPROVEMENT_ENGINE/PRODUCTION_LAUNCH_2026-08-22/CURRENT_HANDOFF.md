...
- public service enforces conclusion evidence ceilings and blocks future-dated sources from supporting earlier-as-of claims/calculations.
- `OBSERVED != VERIFIED_FACT`; PL-03 remains the verification route.
...
- project state, documents, decisions and generic memory remain source-separated;
