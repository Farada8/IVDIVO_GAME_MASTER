...
add(1,'Restore CURRENT authority','PASS','v2 remains VERIFIED_CURRENT; Cycle9 has no authority effect.',('capture-main:4d6dc7c5','CURRENT_IVDIVO_SELF_IMPROVEMENT_STATE schema2.7'))
add(2,'Fresh-main branch reconciliation','PASS','Old Cycle9 branch is diverged; publish from fresh main instead of force overwrite.',('capture:4d6dc7c5','publication:5e406a18'))
...
real=InterruptionObservation('C9-REAL-001',True,('UNKNOWN_PROJECT_SET',),False,False,False)
q=qualify_interruption(real)
add(10,'Classify real browser/dialog interruption','PASS','Real interruption observation accepted without inflating it to qualifying recovery.',q.reasons)
add(11,'Qualify SI-0014 event','HOLD','Current incident does not qualify: project-slice/store/readback/zero-false-resume evidence incomplete.',q.reasons,'Capture a genuine recovery packet during normal project work.')
...
add(31,'Full regression + cold package gate','PASS','Cycle9 deterministic suite and package replay are the required engineering gate; external classes remain separate.',('33/33 warm','33/33 cold'))
