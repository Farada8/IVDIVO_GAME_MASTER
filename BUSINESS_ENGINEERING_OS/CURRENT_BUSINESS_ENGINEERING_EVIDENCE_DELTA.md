...
- Historical same-buyer tender `8176962` is retrieval-pattern evidence only; it cannot assert current tender requirements.
- Private primary formation evidence verifies supplier legal name `SYNTHESIS-IVDIVO LIMITED` and legal form, but supplier capability remains unverified.
