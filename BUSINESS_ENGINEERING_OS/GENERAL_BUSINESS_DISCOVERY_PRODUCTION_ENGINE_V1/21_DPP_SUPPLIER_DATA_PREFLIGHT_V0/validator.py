...
def validate_record(record: dict[str, Any], legal_applicability: str) -> dict[str, Any]:
    ...
    return {
        ...
        "counts": {
            "PASS": sum(f.outcome == "PASS" for f in findings),
            "GAP": len(gaps),
            "HOLD": len(holds),
            "ERROR": len(errors),
        },
        ...
        "proof_boundary": {
            "legal_dpp_applicability_proven": legal_applicability != "UNKNOWN",
            "registry_production_submission_proven": False,
            "conformity_proven": False,
...
def compare_correction(fixture: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "proof_boundary": {
            "correction_loop_is_legal_compliance_proof": False,
            "correction_loop_is_registry_acceptance_proof": False,
            "technical_data_delta_proven_on_synthetic_fixture": len(closed) >= 2,
        },
    }
