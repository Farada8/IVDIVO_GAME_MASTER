# SYMMETRY DISCOVERY — RESULTS

## Canonical four-peer counts

- S4: group size 24, relation types 4
- S2 x S2: group size 4, relation types 8
- C4: group size 4, relation types 5
- identity only: group size 1, relation types 15

## Interpretation

For four peers the same 15 formal relations can mean very different numbers of structural relation types.

- full interchangeability S4 -> 4 relation types;
- two independent interchangeable blocks S2 x S2 -> 8 types;
- cyclic rotation C4 -> 5 types;
- unique roles -> 15 types.
...
Move from symmetry discovery to invariant-generator discovery: find the smallest generator family whose algebra/representation is sufficient for all declared tasks and interventions, rather than retaining every orbit sum.
